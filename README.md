...
## Junior Cyber Security Analyst | IT Support | SOC Pathway

I am a career changer based in Manchester with hands-on training in cybersecurity, IT support, Linux, Python, SQL, networking, vulnerability scanning, and secure coding.

I completed practical cybersecurity training through HyperionDev / University of Manchester, including projects covering reconnaissance, SQL injection, Linux automation, Python scripting, and database systems.
...
- Linux command line and basic administration
- Python scripting and automation
- SQL and SQLite databases
- Bash scripting and cron jobs
- Networking basics: TCP/IP, DNS, DHCP, IP addressing
...
Linux automation project using Bash scripts and cron jobs for scheduled backups and logging.  
...
I am seeking an entry-level IT Support, Service Desk, Security Support, Junior SOC Analyst, or Junior Cyber Security Analyst role where I can build real-world experience and continue developing towards cybersecurity.

---

## 📫 Contact

- GitHub: [navthediffender](https://github.com/navthediffender)
- LinkedIn: [Navid Shirzadegan](https://www.linkedin.com/in/navid-shirzadegan-9a26583a5/)
